 ...
 * @author Mustafa
 */
public class GroupGUIPreviewOnly extends Window {
    ...
    public GroupGUIPreviewOnly(/*Group group,User user*/) {
        initComponents();
        prepare("Group");
//        this.group = null;
//        this.user = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroupGUIPreviewOnly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GroupGUIPreviewOnly().setVisible(true);
            }
        });
    }
